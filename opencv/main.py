...
import numpy as np
#cargamos imagen
image1 = cv2.imread('goku.png')
image2 = cv2.imread('naruto.jpg')
image3 = cv2.imread('pokemon.png')
image4 = cv2.imread('ranma.jpg')
image5 = cv2.imread('realistic image of Harry Potter.png')
image6 = cv2.imread('Sailor Moon.png')
image7 = cv2.imread('super.jpg')
...
scaled = cv2.resize(image4, (new_height, new_width))
...
image = cv2.imread('goku.png', cv2.IMREAD_GRAYSCALE)
